    ...
    <div className="w-full bg-black">
      ...
      <div className="w-full flex justify-center items-center px-6 py-16">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 60% 80% at 50% 50%, #3d0015 0%, #1a000a 40%, #0a0a0a 100%)",
          }}
        >
          <h4 className="text-4xl text-white font-argent">
            Partner With KGRN
          </h4>
          ...
          <div className="mt-4 flex gap-6 mx-auto">
            <Link
              className="bg-[#c0143c] py-3 px-10 rounded-md font-semibold text-lg text-white hover:bg-[#e01a47] transition-all duration-300"
              href={"/"}
            >
              Become a Partner
            </Link>
      ...
      <div className="border-t border-[#1f1f1f] px-16 py-8 flex justify-between items-start">
        ...
        <div className="flex flex-col items-end gap-3">
          <div className="flex gap-8">
            {["Privacy", "DPA", "Terms", "Partners", "Cookie Preferences"].map((item) => (
              <Link
                key={item}
                href={"/"}
          ...
          <p className="text-gray-500 text-sm">2026 © KGRN. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
